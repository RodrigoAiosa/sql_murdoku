...
GOOGLE_SCRIPT_WEBAPP_URL = "https://script.google.com/macros/s/AKfycbxDTdoQaDoAwFWmCpnO88OSd-4jaJPXKI16A5VfhjSYgfBPB-RKjZyvADLfSM-VZ0ww3Q/exec"  # <-- cole aqui a URL /exec do seu Apps Script (ver README)
